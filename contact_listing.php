...
$query =' SELECT * FROM `contacts` WHERE author_id ='.$author_id.' limit '.$limit.' OFFSET '.$offset ;
$result =mysqli_query($connection,$query);
$output =[];  
$pagination = true;
...
<div class="container">
  ...
  <table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="http://localhost/assignment3/dele_contact.php?id=<?php echo $value['id']; ?>" class="btn btn-danger" role="button">Delete</a></td>    
            <td><a href="http://localhost/assignment3/edit_contact.php?id=<?php echo $value['id']; ?>" class="btn btn-info" role="button">Edit</a></td> 
        </tr>
       <?php } ?>         
    </tbody>
  </table>
  <?php if($pagination){  ?>
    ...
    <li><a type="button" class="btn btn-submit" href="http://localhost/assignment3/contact_listing.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>  
    <?php } ?>
    </ul> 
    <?php } ?>
